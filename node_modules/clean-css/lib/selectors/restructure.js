...
function restructure(tokens, options) {
  ...
  /**
   * Description
   * @method sendToMultiPropertyMoveCache
   * @param {} position
   * @param {} movedProperty
   * @param {} allFits
   * @return 
  ...
  /**
   * Description
   * @method removeAllMatchingFromCache
   * @param {} matchId
   * @return 
   */
  ...
  /**
   * Description
   * @method shortenMultiMovesIfPossible
   * @param {} position
   * @param {} movedProperty
   * @return CallExpression
   */
  ...
  /**
   * Description
   * @method processMultiPropertyMove
   * @param {} position
   * @param {} propertiesAndMergableTokens
   * @return Literal
   */
  ...
  /**
   * Description
   * @method boundToAnotherPropertyInCurrrentToken
   * @param {} property
   * @param {} movedProperty
   * @param {} token
